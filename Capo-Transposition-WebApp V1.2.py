...
def display_inputs():
    ...
    if capo > 12:
        return '<h2>Your inputs were: {}<br><br>Capo is on fret number {}<br><h2 style=color:red;>Capo is set too high!'.format(input1,capo)
    elif capo == 12:
        return '<h2>Your inputs were: {}<br><h2 style=color:red;>Just play the chords an octave higher!'.format(input1)
